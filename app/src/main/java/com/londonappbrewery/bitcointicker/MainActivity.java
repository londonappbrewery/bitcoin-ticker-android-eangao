...
//                Log.d("Bitcoin", "currrency: " + currency);

                try {

                    mPriceTextView.setText(response.getJSONObject("rates").getJSONObject( currency ).getString( "rate" )  );
                    Log.d("Bitcoin", response.getJSONObject("rates").getJSONObject( currency ).getString( "rate" ));
